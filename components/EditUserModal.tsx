...
export default function EditUserModal({ user, roles, onClose, onSave }: EditUserModalProps) {
                            ...
                            <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left w-full">
                                ...
                                <div className="mt-2">
                                  <p className="text-sm text-gray-500">
                                      Editing role for <span className="font-medium">{user.firstName} {user.lastName}</span> ({user.email}).
                                  </p>
                                </div>
                                <div className="mt-4">
