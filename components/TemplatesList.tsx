  ...
  return (
    <div className="space-y-6">
        <div>
            ...
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Start from a pre-approved template to create new contracts quickly and consistently.</p>
        </div>
        ...
        {filteredTemplates.length === 0 && (
            <div className="text-center py-12 bg-white dark:bg-gray-800 rounded-lg border border-dashed">
                ...
                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Your search for "{searchTerm}" did not match any templates.</p>
            </div>
        )}
    </div>
  );
